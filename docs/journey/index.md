...
读完会话可移植性、压缩和提示缓存三篇译文，我把它们连成了一个问题：换模型、换 Agent 时，手里还剩下多少可检查、可修改的工作记录？

[阅读《Pi 为什么把会话与上下文留在你手里》](/journey/why-pi-keeps-context-editable)
