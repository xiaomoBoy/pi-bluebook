---
title: 寫在藍皮書之外
description: 小墨同學關於 Pi 的個人感悟、學習過程、踩坑記錄與推文檔案。
prev:
  text: 權限、隔離與驗收
...
這裡保留我的個人感悟、學習過程和判斷變化。很多判斷來自一次實作，後來讀到原始碼或文章，又會回頭修正早先的理解。它們不會被改寫成一條過分整齊的成功路線，也不承擔藍皮書教學的職責。

下面這段話是我決定整理藍皮書時寫下的原文。

<article class="tweet-entry tweet-entry-featured">

<span class="tweet-meta">2026-09-08 18:48:38 · 小墨同學原文</span>
...
讀完工作階段可移植性、壓縮和提示快取三篇譯文，我把它們連成了一個問題：換模型、換 Agent 時，手裡還剩下多少可檢查、可修改的工作記錄？

[閱讀《Pi 為什麼把工作階段與上下文留在你手裡》](/zh-TW/journey/why-pi-keeps-context-editable)
...
<a class="journey-stage-card" href="/zh-TW/tweets/01-meet-pi">
  ...
  <small>先理解 Pi 是什麼、為什麼保持簡潔，以及代理框架（Agent Harness）會怎樣影響實際體驗。</small>
</a>
...
<a class="journey-stage-card" href="/zh-TW/tweets/03-sessions-context">
  ...
  <strong>理解工作階段（Session）與上下文</strong>
...
<a class="journey-stage-card" href="/zh-TW/tweets/04-skills-extensions">
  ...
  <strong>搭建自己的技能（Skill）與擴充功能（Extension）</strong>
...
想了解是誰在整理這條路線，可以讀[關於作者](/zh-TW/about)。
