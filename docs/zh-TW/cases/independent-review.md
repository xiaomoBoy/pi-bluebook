...
prev: { text: CASE 04 · 最小擴充功能, link: /zh-TW/cases/first-extension }
...
兩路工作階段互不讀取對方結論，並且只由主工作階段寫 `merged.md`。這裡練習的是可審計的分工結構，不是假定核心內建了一個“子代理按鈕”。[第 12 課](/zh-TW/guide/subagents)解釋這種手動分工與子代理擴充的關係。
