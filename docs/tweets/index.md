...
其中散落在多篇推文里的 Extension、Package、Skill 和独立客户端，已经另行整理为[插件推荐与选择地图](/plugins/)。推荐页会核对当前来源和风险；本目录继续保留当时的原始判断。

其中反复出现、经过后续实践仍未被推翻的学习原则，已经蒸馏为[从 98 条推文留下的十条判断](/guide/lasting-principles)。那一页属于蓝皮书当前结论；这里继续保存原始表达、发布日期和认识变化，两边不会互相覆盖。
